var RTCPeerConnection, getUserMedia, attachMediaStream, reattachMediaStream,
        ...
        if (url_parts[0].indexOf('stun') === 0) {
            ...
            if (webrtcDetectedVersion < 27) {
                ...
                if (turn_url_parts.length === 1 || turn_url_parts[1].indexOf('transport=udp') === 0) {
                    ...
                    // FF 27 and above supports transport parameters in TURN
                    // url, so passing in the full url to create iceServer.
                    iceServer = {
                        'url': url,
                        'credential': password,
                        'username': username
